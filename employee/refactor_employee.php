...
$id_fare_term = "SELECT * FROM employee WHERE id_employee = {$_GET['id']}";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        ...
        $add_tariff = "UPDATE employee SET number = $number, fio = '$pib', position = '$position' WHERE id_employee = {$_GET['id']}";
...
<form method="post" enctype="multipart/form-data">
    <div class="container" style="width: 25%; margin-top: 15%">
        <main class="form-signin w-100 m-auto">
            <h1 class="h3 mb-3 fw-normal">Редагувати працівника</h1>
            ...
            <div class="form-floating" style="margin-bottom: 5%">
                <input type="text" class="form-control" id="floatingInput" placeholder="name_tariff" name="pos" value="<? echo $result_id[3] ?>">
                <label for="floatingInput">Посада</label>
            </div>

            <div class="form-floating" style="margin-bottom: 5%">
                <input type="number" class="form-control" id="floatingPassword" placeholder="number" value="<? echo $result_id[1] ?>"
                       name="number">
