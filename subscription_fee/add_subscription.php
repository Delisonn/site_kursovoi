...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        ...
        $add_tariff = "INSERT INTO subscription_fee VALUES(null, '$date_end-01', $cost, '$date_active-01')";
...
<form method="post" enctype="multipart/form-data">
    <div class="container" style="width: 25%; margin-top: 15%">
        <main class="form-signin w-100 m-auto">
            <h1 class="h3 mb-3 fw-normal">Додати підписку</h1>
            ...
            <div>
                ...
                <input type="month" id="start" name="date_start"
                        value="2022-11" class="data-input form-control">
            </div>
