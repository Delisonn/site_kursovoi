...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <div class="navbar-nav">
                <a class="nav-link active" aria-current="page" href="subscription_fee.php">Підписка</a>
            </div>
            <div class="navbar-nav">
        ...
        <div class="row">
            ...
            <? if($_SESSION['auth'] && $user->getAccessLevel() >= 0) {
                ...
                <div class="mt-5 mb-3 clearfix">
                    <h2 class="pull-left">Додати підписку</h2>
                    <a href="add_subscription.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i>Додати підписку</a>
                </div>';} ?>
                <?php
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>
                                    ...
                                    <td>$row[cost]</td>" ?>
                                    <? if ($_SESSION['auth'] && $user->getAccessLevel() >0) {
                                    echo "<td> <a href='refactor_subscription.php?id=$row[id_subscription]' class='mr-3' title='Оновити тариф' data-toggle='tooltip' ><span class='fa fa-pencil'></span></button>
                                    <a href='delete.php?id=$row[id_subscription]' title='Видалити тариф' data-toggle='tooltip'><span class='fa fa-trash'></span></a></td> "; }?>
                                    <?
                            echo "</tr>";
                        }
                        echo "</tbody>";
