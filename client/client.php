...
$query = "SELECT * FROM tariffs, client WHERE tariff_id = id_tariff";
...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <div class="navbar-nav">
                <a class="nav-link active" aria-current="page" href="client.php">Клієнти</a>
            </div>
            <div class="navbar-nav">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="mt-5 mb-3 clearfix">
                    <h2 class="pull-left">Додати нового клієнта</h2>
                    <a href="add_client.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i>Додати нового клієнта</a>
                </div>';} ?>
                <?php
                if ($result = mysqli_query($connection, $query)) {
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <? if ($_SESSION['auth'] && $user->getAccessLevel() >0) {
                                echo "<td> <a href='refactor_client.php?id=$row[id_client]' class='mr-3' title='Оновити тариф' data-toggle='tooltip' ><span class='fa fa-pencil'></span></button>
                                    <a href='delete.php?id=$row[id_client]' title='Видалити тариф' data-toggle='tooltip'><span class='fa fa-trash'></span></a></td> "; }?>
                            <?
                            echo "</tr>";
                        }
                        echo "</tbody>";
