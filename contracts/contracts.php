...
<head>
    ...
    <title>Перегляд контрактів</title>
</head>
<body>
<?php
session_start();
...
$query = "SELECT id_contract, cl.fio AS clfio, em.fio AS emfio, activation_date, end_date, cost, id_client, id_contract FROM contracts cn INNER JOIN client cl ON cn.client_id = cl.id_client INNER JOIN employee em ON em.id_employee = cn.employee_id INNER JOIN subscription_fee sf ON cn.subscription_id = sf.id_subscription WHERE id_contract";
...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <div class="navbar-nav">
                <a class="nav-link active" aria-current="page" href="contracts.php">Контракти</a>
            </div>
            <div class="navbar-nav">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="mt-5 mb-3 clearfix">
                    <h2 class="pull-left">Додати новий контракт</h2>
                    <a href="add_contracts.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i>Додати новий контракт</a>
                </div>';}?>
                <?php
                if ($result = mysqli_query($connection, $query)) {
                    if (mysqli_num_rows($result) > 0) {
                        echo "<table class='table table-bordered table-striped'>
                                ...
                                <th>Дата активації тарифу</th>
                                <th>Дата зацінчення тарифу</th>
                                <th>Ціна</th>"; ?>
                                <? if ($_SESSION['auth'] && $user->getAccessLevel() >0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>
                                    ...
                                    "; ?>
                            <? if ($_SESSION['auth'] && $user->getAccessLevel() >0) {
                                echo "<td> <a href='refactor_contracts.php?id=$row[id_contract]' class='mr-3' title='Оновити тариф' data-toggle='tooltip' ><span class='fa fa-pencil'></span></button>
                                    <a href='delete.php?id=$row[id_contract]' title='Видалити тариф' data-toggle='tooltip'><span class='fa fa-trash'></span></a></td> "; }?>
                            <?
                            echo "</tr>";
                        }
                        echo "</tbody>";
