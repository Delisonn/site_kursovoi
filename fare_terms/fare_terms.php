...
<head>
    ...
    <title>Перегляд умов тарифів</title>
</head>
<body>
<?php
session_start();
...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <div class="navbar-nav">
                <a class="nav-link active" aria-current="page" href="fare_terms.php">Умови тарифів</a>
            </div>
            <div class="navbar-nav">
            ...
            <div class="col-md-12">
                <div class="mt-5 mb-3 clearfix">
                    <? if($_SESSION['auth'] && $user->getAccessLevel() >= 0) {
                        echo '
                    <h2 class="pull-left">Додати нову умову тарифу</h2>
                    <a href="add_fare_term.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i>Додати
                        нову умову</a>
                </div>';}?>
                <?php
                if ($result = mysqli_query($connection, $query)) {
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>
                                    <td>$row[fare_term_tariff]</td>"; ?>
                                    <? if ($_SESSION['auth'] && $user->getAccessLevel() >0) {
                                    echo "<td> <a href='refactor_fare_term.php?id=$row[id_fare_terms]' class='mr-3' title='Оновити тариф' data-toggle='tooltip' ><span class='fa fa-pencil'></span></button>
                                    <a href='delete.php?id=$row[id_fare_terms]' title='Видалити тариф' data-toggle='tooltip'><span class='fa fa-trash'></span></a></td> "; }?>
                                    <?
                            echo "</tr>";
                        }
                        echo "</tbody>";
