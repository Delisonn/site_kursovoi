    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <a class="nav-link active" aria-current="page" href="tariffs.php">Тарифи</a>
            </div>
            <div class="navbar-nav">
            ...
            <div class="col-md-12">
               <? if($_SESSION['auth'] && $user->getAccessLevel() >= 0) {
                echo '<div class="mt-5 mb-3 clearfix">
                    <h2 class="pull-left">Додати новий тариф</h2>
                    <a href="add_tariff.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i>Додати
                        новий тариф</a>
                </div>';}?>
                <?php
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>
                                    ...
                                    <td>$row[tariff_cost]</td>"; ?>
                                    <? if ($_SESSION['auth'] && $user->getAccessLevel() >0) {
                                    echo "<td> <a href='refactor_tariff.php?id=$row[id_tariff]' class='mr-3' title='Оновити тариф' data-toggle='tooltip' ><span class='fa fa-pencil'></span></button>
                                    <a href='delete.php?id=$row[id_tariff]' title='Видалити тариф' data-toggle='tooltip'><span class='fa fa-trash'></span></a></td> "; }?>
                                    <?
                            echo "</tr>";
                        }
                        echo "</tbody>";
