...
$id_fare_term = "SELECT * FROM tariffs WHERE id_tariff = {$_GET['id']}";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        ...
        $add_tariff = "UPDATE tariffs SET tariff_name = '$name', tariff_cost = $cost, fare_terms_id = {$_POST['fare_term']} WHERE id_tariff = {$_GET['id']}";
...
<form method="post" enctype="multipart/form-data">
    <div class="container" style="width: 25%; margin-top: 15%">
        <main class="form-signin w-100 m-auto">
            <h1 class="h3 mb-3 fw-normal">Редагувати тариф</h1>
            ...
            <div class="form-floating" style="margin-bottom: 5%">
                <input type="text" class="form-control" id="floatingInput" placeholder="name_tariff" name="name_tariff" value="<? echo $result_id[1];?>">
